...
<script>
import banner1 from '../../../assets/ball2.png'
import banner2 from '../../../assets/tuya2.png'
import banner3 from '../../../assets/ball2.png'
import banner4 from '../../../assets/tuya2.png'
export default {
	name: 'home',
	  data () {
	    return {
	    	nowIndex: 0,
        listWidth: '960',
        list: [banner1, banner2,banner3,banner4],
        timer:null
	    }
	},
    methods: {
