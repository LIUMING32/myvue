	...
	<div class="contain">
		...
		<div style="margin: 0 auto;width: 960px;">
			<el-container>
				<el-main style="display: inline-block;">
					<el-tabs v-model="activeName" @tab-click="handleClick">
						...
						<el-tab-pane label="瀑布流" name="second">
							...
							<el-row :gutter="20" style="width: 740px;">
				...
				<el-aside width="200px" style="display: inline-block;margin-left: 20px;">
					<el-card class="box-card">
						...
						<ul>
							<li v-for="but in buts" :key="but.but1" class="text item">
								<el-button round>{{but.but1 }}</el-button>
								<el-button round>{{but.but2}}</el-button>
							</li>
						</ul>
					</el-card>
					<el-card class="box-card">
